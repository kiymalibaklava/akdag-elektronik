...
<body style="margin:0;padding:0;background:#0f0f0f;font-family:'Segoe UI',Arial,sans-serif">
  <div style="max-width:600px;margin:0 auto;padding:32px 16px">
    ...
    <div style="background:#1a1a1a;border-left:4px solid #DA291C;padding:24px 28px;margin-bottom:24px">
      ...
      <div style="color:#fff;font-size:22px;font-weight:900;text-transform:uppercase;letter-spacing:0.05em">Siparişiniz Alındı</div>
...
export function iletisimAdminHTML(data: { ad: string, soyad?: string | null, telefon?: string | null, email: string, konu?: string | null, mesaj: string }): string {
...
<div style="max-width:560px;margin:0 auto;padding:24px 16px">
  <div style="background:#DA291C;padding:14px 20px;margin-bottom:16px"><div style="color:#fff;font-size:16px;font-weight:900;text-transform:uppercase">Yeni iletişim mesajı</div></div>
  <div style="background:#141414;border:1px solid #222;padding:20px;color:#ccc;font-size:14px;line-height:1.6">
    ...
    <p style="margin:0 0 8px"><strong style="color:#fff">E-posta:</strong> ${data.email}</p>
